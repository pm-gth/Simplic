...
I started this project with the goal of learning of an interpreter works. The 
...
the variables in a memory bank
...
A Makefile is facilitated to build the program, ir accepts the following rules:
